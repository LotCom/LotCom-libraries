...
/// <summary>
/// A DatabaseEntry that represents a Print operation in the LotCom database.
/// </summary>
public class Print(Process Process, Part Part, PartialDataSet PrimaryDataSet, VariableFieldSet VariableFields, DateTime ProductionDate, PartialDataSet? FirstPartialDataSet = null, PartialDataSet? SecondPartialDataSet = null) : DatabaseEntry(Process, Part, PrimaryDataSet, VariableFields, ProductionDate, FirstPartialDataSet, SecondPartialDataSet)
{
    /// <summary>
    /// Converts the Print into a database-ready CSV-formatted string.
    /// </summary>
    /// <returns></returns>
    public string ToCSV()
    {
        ...
        return $"{Process.FullName},{Part.ToCSV()},{FullQuantity},{VariableFields.ToCSV()},{new Timestamp(ProductionDate).Stamp},{FullShift},{FullOperator}";
    }

    /// <summary>
    /// Parses an existing Print entry (EntryString) from the database into a Print object.
    /// </summary>
    /// <param name="EntryString"></param>
    /// <returns></returns>
    /// <exception cref="DatabaseException"></exception>
    /// <exception cref="FormatException"></exception>
    public static async Task<Print> Parse(string EntryString)
    {
        ...
        // construct and return the Print object
        return new Print
        (
            Process: Process,
            Part: Part,
